        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "QUEEN-DANI~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `💚 *QUEEN-DANI-V1 Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by DAMINI-DEV\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/Nerdk-tech/QUEEN-DANI-MD-\n` +
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: "QUEEN-DANI-SUPPORT",
                                serverMessageId: 143
                            }
                        }
                    };
